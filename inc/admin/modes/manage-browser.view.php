...
$addBrowser->setInputField(array('name'=>'Browser_Name', 'placeholder'=>'Chrome', 'required'=>true, 'value'=>$browser->Browser_Name), 'Browser Name: ', true);
$addBrowser->setInputField(array('name'=>'Browser_MajorVer', 'type'=>'number', 'placeholder'=>'17', 'required'=>true, 'value'=>$browser->Browser_MajorVer), 'Major Version: ', true);
